            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={4}>
                ...
                <div className={classes.helperText}>
                  Escolha qual gateway de pagamento será usado na hora da fatura (SaaS).
                </div>
              </Grid>

              {config.paymentGateway === "mercadopago" && (
                <Grid item xs={12}>
                  <TextField
                  ...
                  />
                  <div className={classes.helperText}>
                    Token da conta principal para as empresas renovarem o CRM.
                  </div>
                </Grid>
              )}

              {config.paymentGateway === "asaas" && (
                <Grid item xs={12}>
                  <TextField
                    label="API Key (Asaas)"
                    name="asaasToken"
                  ...
                  />
                  <div className={classes.helperText}>
                    Token gerado no painel do Asaas ("Configurações > Integrações > Gerar API Key").
                  </div>
                </Grid>
              )}
            </Grid>
