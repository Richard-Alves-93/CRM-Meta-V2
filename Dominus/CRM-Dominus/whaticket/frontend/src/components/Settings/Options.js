      ...
      <Grid spacing={3} container>
        ...
        {isSuper() ? (
          <Grid xs={12} sm={6} md={4} item>
            <FormControl className={classes.selectContainer} margin="normal">
              <FormControlLabel
                control={
                  <Switch
                    checked={userCreation === "enabled"}
                    onChange={async (e) => {
                      handleChangeUserCreation(e.target.checked ? "enabled" : "disabled");
                    }}
                    color="primary"
                  />
                }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={async (e) => {
                    handleChangeUserRating(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={async (e) => {
                    handleUserRandom(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={async (e) => {
                    handleSettingsTransfTicket(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={async (e) => {
                    handleSendSignMessage(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={async (e) => {
                    handleSendGreetingMessageOneQueues(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={async (e) => {
                    handleSendQueuePosition(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={async (e) => {
                    handleSendFarewellWaitingTicket(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={async (e) => {
                    handleAcceptAudioMessageContact(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={async (e) => {
                    handleEnableLGPD(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={async (e) => {
                    handleRequiredTag(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer} margin="normal">
            <FormControlLabel
              control={
                <Switch
                  checked={closeTicketOnTransfer === "enabled"}
                  onChange={async (e) => {
                    handleCloseTicketOnTransfer(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer} margin="normal">
            <FormControlLabel
              control={
                <Switch
                  checked={lgpdConsent === "enabled"}
                  onChange={async (e) => {
                    handleLGPDConsent(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
        ...
        <Grid xs={12} sm={6} md={4} item>
          <FormControl className={classes.selectContainer} margin="normal">
            <FormControlLabel
              control={
                <Switch
                  checked={lgpdHideNumber === "enabled"}
                  onChange={async (e) => {
                    handleLGPDHideNumber(e.target.checked ? "enabled" : "disabled");
                  }}
                  color="primary"
                />
              }
